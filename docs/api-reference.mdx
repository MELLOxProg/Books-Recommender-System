---
title: 'API Reference'
description: 'Programmatic interface for the Book Recommender System'
---

## API Overview

The Book Recommender System provides a programmatic interface for generating book recommendations. While the primary interface is through the Streamlit web application, you can also integrate the recommendation engine directly into your own applications.
...
<AccordionGroup>
  <Accordion title="Direct Integration">
    ```python
    import pickle
    import numpy as np
  ...
  <Accordion title="Batch Processing">
    ...
    results = batch_recommender.batch_recommendations(books_to_process)
    batch_recommender.export_recommendations(results)
    ```
  </Accordion>
</AccordionGroup>
